...
export const WHY_CHOOSE = [
  ...
  { icon: 'Users', title: 'Caring Community', description: 'A supportive, family-like environment where every child belongs and is known by name.' },
...
export const ACHIEVEMENTS = [
  ...
  { title: 'Regional Reading Competition', year: '2023', description: 'Our reading club took first place in the regional Amharic reading competition.', icon: 'BookOpen' },
...
export const CORE_VALUES = [
  ...
  { icon: 'HeartHandshake', title: 'Compassion', description: 'We treat every person with dignity, kindness, and respect.' },
  { icon: 'Users', title: 'Community', description: 'We belong to and serve a diverse, inclusive, and vibrant family.' },
  { icon: 'Lightbulb', title: 'Curiosity', description: 'We ask bold questions and seek understanding with open minds.' },
...
export const POLICIES = [
  ...
  { title: 'Anti-Bullying Policy', description: 'Hamza maintains a zero-tolerance stance on bullying, with a confidential reporting system.' },
  { title: 'Technology Acceptable Use', description: 'Devices are used responsibly for learning, following our digital citizenship guidelines.' },
  { title: 'Health & Safety', description: 'Comprehensive safeguarding, emergency drills, and on-site nursing staff protect our community.' },
...
export const NEWS = [
  ...
  { title: 'Students Lead Bole Neighborhood Cleanup', excerpt: 'Our Civics & Ethics Club mobilized 200 students to clean up Bole Road and surrounding areas.', date: '2025-01-22', category: 'Community', author: 'Student Council', image: 'community' },
  { title: 'New Reading Corner Opens in Lower Primary', excerpt: 'A cozy library space with over 500 storybooks now welcomes our Grade 1–4 students daily.', date: '2025-01-10', category: 'Academics', author: 'Academic Office', image: 'reading' },
  { title: 'Hamza Students Win Regional Quran Competition', excerpt: 'Three of our students placed in the top 10 at the regional Quran recitation competition.', date: '2024-12-15', category: 'Achievement', author: 'Religious Studies', image: 'quran' },
  { title: 'Winter Term Honor Roll Celebrated', excerpt: '180 students achieved distinction for academic excellence and exemplary conduct.', date: '2024-12-02', category: 'Academics', author: 'Academic Office', image: 'honor-roll' },
]
...
export const EVENTS = [
  ...
  { title: 'Inter-House Sports Day', date: '2025-05-02', time: '8:30 AM', location: 'Sports Field', category: 'Sports', description: 'A full day of track and team sports across our school houses.' },
...
export const GALLERY = [
  ...
  { title: 'Annual Graduation Ceremony', category: 'Graduation', image: 'graduation' },
  { title: 'Inter-House Sports Day', category: 'Sports', image: 'sports' },
  { title: 'Cultural Heritage Day', category: 'Culture', image: 'culture' },
  { title: 'Annual Science Fair', category: 'Events', image: 'science-fair' },
  { title: 'Biology Lab Session', category: 'Events', image: 'biology-lab' },
  { title: 'Art Exhibition', category: 'Arts', image: 'art' },
  { title: 'Spring Music Festival', category: 'Arts', image: 'music-fest' },
  { title: 'Reading Corner', category: 'Campus', image: 'library' },
  { title: 'Environment Club Garden', category: 'Culture', image: 'garden' },
  { title: 'Field Day Celebration', category: 'Sports', image: 'field-day' },
]
